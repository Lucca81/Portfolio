...
const projects: Project[] = [
    ...
    },
    {
        ...
        subtitle: 'Controle de estoque de relógios',
        description:
            'API RESTful desenvolvida em Spring Boot para controle de estoque e catálogo de relógios. O grande diferencial do projeto é uma engine de busca avançada usando JPA Specifications, permitindo filtros dinâmicos complexos, paginação e ordenação. Com arquitetura em camadas, o sistema utiliza PostgreSQL, padrões DTO, Mappers com regras de negócio e tratamento global de exceções (@ControllerAdvice) para garantir segurança, performance e código limpo.',
        techStack: ['Java 17+', 'Spring Boot', 'PostgreSQL', 'Spring Data JPA', 'JPA Specifications', 'REST API'],
        apis: ['REST API'],
        color: '#3b82f6',
        accentGradient: 'linear-gradient(135deg, #3b82f620, #00f0ff20)',
        icon: '⌚',
        category: 'Back-end',
        githubUrl: 'https://github.com/Lucca81/controle-de-estoque',
    },
];
